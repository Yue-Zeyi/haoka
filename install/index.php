...
$databaseFile = '../untils/config.php'; //数据库配额文件
...
\$dbconfig=array(
  ...
  if (!$dbconfig['user'] || !$dbconfig['pwd'] || !$dbconfig['dbname']) {
    ...
    if (empty($errorMsg) && !$_GET['jump']) {
      ...
      $DB->exec("set sql_mode = ''");
      $DB->exec("set names utf8");
      $sqls = file_get_contents('haoka.sql');
      $sqls = explode(';', $sqls);
      $success = 0;
      $error = 0;
      $errorMsg = null;
  ...
  <div class="container"><br>
    <div class="row">
      <div class="col-xs-12 col-sm-10 col-md-8 center-block" style="float: none;">
        ...
        <div class="panel panel-warning">
          ...
          <?php } elseif ($step == 3) { ?>
            ...
            <div class="panel-body">
              ...
              ?>
                  <div class="list-group-item list-group-item-info text-center">系统检测到你已安装过号卡推广管理平台</div>
          ...
          <?php } elseif ($step == 5) { ?>
            ...
            <div class="panel-body">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item">2、用户地址：<a href="../user/" target="_blank">/user/</a> 管理员自行添加用户</li>
                ...
                <li class="list-group-item"><a href="../admin" class="btn btn-block btn-default">进入管理员后台</a></li>
              </ul>
            </div>
          <?php } else { ?>
        ...
        <footer class="footer">
          <pre><center>Powered by <a href="https://www.yuezeyi.com" target="_blank">岳泽以</a> !</center></pre>
        </footer>
      </div>
    </div>
  </div>
